...
::: {#fig-combine-distributions-qq-plot}
```{r}
#| code-fold: true
...
Assuming the data were valid and the t-test assumptions were met, the analysis found no statistically significant difference in means ($t$ = 0.789, $p$-value = `{r} p_value$p_value |> round(3)`). The observed effect size was very small and did not exceed the Minimum Effect Size ([MES](https://en.wikipedia.org/wiki/Effect_size)) threshold (Cohen's $d$ = 0.065, 95% CI [-0.118, 0.248]), indicating any potential difference is likely negligible or effectively zero within the 95% confidence interval bounds.
